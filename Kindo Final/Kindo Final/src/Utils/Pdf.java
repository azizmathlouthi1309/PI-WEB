...
public class Pdf {
    ...
    public void GeneratePdf(String filename) throws FileNotFoundException, DocumentException, BadElementException, IOException, InterruptedException, SQLException
    {
        ...
        for(User u:list)
        {
        document.add(new Paragraph("<h1>HELLO</h1>"));
    ...
    public void runpdf(String pdffile) throws IOException
    {
        Process pro=Runtime.getRuntime().exec("rundll32 url.dll,FileProtocolHandler "+pdffile+".pdf");
    }
}
